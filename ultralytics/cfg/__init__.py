...
from ultralytics.utils import DEFAULT_CFG_DICT, LOGGER, RANK, ROOT, RUNS_DIR, TESTS_RUNNING, IterableSimpleNamespace, colorstr, deprecation_warn, yaml_load
...
def check_dict_alignment(base: Dict, custom: Dict, e=None):
    ...
    if mismatched := [k for k in custom_keys if k not in base_keys]:
        ...
        raise SyntaxError(string + "Use scripts/train.py or scripts/evaluate.py.") from e
